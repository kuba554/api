 ...
 */
class getCategoriesTreeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoriesTreeRepository' shared autowired service.
     *
     * @return \App\Repository\CategoriesTreeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoriesTreeRepository.php';

        return $container->privates['App\\Repository\\CategoriesTreeRepository'] = new \App\Repository\CategoriesTreeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
