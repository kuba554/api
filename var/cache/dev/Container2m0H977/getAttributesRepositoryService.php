 ...
 */
class getAttributesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AttributesRepository' shared autowired service.
     *
     * @return \App\Repository\AttributesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AttributesRepository.php';

        return $container->privates['App\\Repository\\AttributesRepository'] = new \App\Repository\AttributesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
