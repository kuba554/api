 ...
 */
class getProducersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProducersRepository' shared autowired service.
     *
     * @return \App\Repository\ProducersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProducersRepository.php';

        return $container->privates['App\\Repository\\ProducersRepository'] = new \App\Repository\ProducersRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
