 ...
 */
class getUnitsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UnitsRepository' shared autowired service.
     *
     * @return \App\Repository\UnitsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UnitsRepository.php';

        return $container->privates['App\\Repository\\UnitsRepository'] = new \App\Repository\UnitsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
