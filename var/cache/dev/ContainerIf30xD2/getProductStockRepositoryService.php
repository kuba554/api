 ...
 */
class getProductStockRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProductStockRepository' shared autowired service.
     *
     * @return \App\Repository\ProductStockRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductStockRepository.php';

        return $container->privates['App\\Repository\\ProductStockRepository'] = new \App\Repository\ProductStockRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
