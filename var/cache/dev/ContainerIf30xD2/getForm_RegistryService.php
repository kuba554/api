...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\ApiTestType' => ['privates', 'App\\Form\\ApiTestType', 'getApiTestTypeService', true],
            'App\\Form\\AttributesType' => ['privates', 'App\\Form\\AttributesType', 'getAttributesTypeService', true],
            'App\\Form\\CategoriesTree2Type' => ['privates', 'App\\Form\\CategoriesTree2Type', 'getCategoriesTree2TypeService', true],
            'App\\Form\\CategoriesTreeType' => ['privates', 'App\\Form\\CategoriesTreeType', 'getCategoriesTreeTypeService', true],
            ...
            'App\\Form\\ImagesType' => ['privates', 'App\\Form\\ImagesType', 'getImagesTypeService', true],
            'App\\Form\\PostType' => ['privates', 'App\\Form\\PostType', 'getPostTypeService', true],
            'App\\Form\\ProductImagesType' => ['privates', 'App\\Form\\ProductImagesType', 'getProductImagesTypeService', true],
            'App\\Form\\ProductStockType' => ['privates', 'App\\Form\\ProductStockType', 'getProductStockTypeService', true],
            'App\\Form\\ProductType' => ['privates', 'App\\Form\\ProductType', 'getProductTypeService', true],
            'App\\Form\\Type\\ChangePasswordType' => ['privates', 'App\\Form\\Type\\ChangePasswordType', 'getChangePasswordType2Service', true],
            ...
            'App\\Form\\ApiTestType' => '?',
            'App\\Form\\AttributesType' => '?',
            'App\\Form\\CategoriesTree2Type' => '?',
            'App\\Form\\CategoriesTreeType' => '?',
            'App\\Form\\ChangePasswordType' => '?',
            'App\\Form\\CommentType' => '?',
            'App\\Form\\ImagesType' => '?',
            'App\\Form\\PostType' => '?',
            'App\\Form\\ProductImagesType' => '?',
            'App\\Form\\ProductStockType' => '?',
