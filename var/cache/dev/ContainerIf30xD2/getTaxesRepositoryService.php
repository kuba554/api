 ...
 */
class getTaxesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaxesRepository' shared autowired service.
     *
     * @return \App\Repository\TaxesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaxesRepository.php';

        return $container->privates['App\\Repository\\TaxesRepository'] = new \App\Repository\TaxesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
