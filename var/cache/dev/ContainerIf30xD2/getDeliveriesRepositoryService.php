 ...
 */
class getDeliveriesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeliveriesRepository' shared autowired service.
     *
     * @return \App\Repository\DeliveriesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeliveriesRepository.php';

        return $container->privates['App\\Repository\\DeliveriesRepository'] = new \App\Repository\DeliveriesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
