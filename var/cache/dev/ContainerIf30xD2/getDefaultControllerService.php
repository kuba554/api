...
class getDefaultControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.ZoQtt3p'] ?? $container->load('get_ServiceLocator_ZoQtt3pService'))->withContext('App\\Controller\\DefaultController', $container));
