...
class __TwigTemplate_f6d17048bcb2702e242887d86b073f73 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_table_components($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["component"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["component"], "template_path", [], "any", false, false, false, 230)) {
                ...
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension']->getFileLink(twig_get_attribute($this->env, $this->source, $context["component"], "template_path", [], "any", false, false, false, 231), 1), "html", null, true);
                echo "\">";
                // line 232
...
{% endblock %}
", "@TwigComponent/Collector/twig_component.html.twig", "C:\\Users\\admin\\Desktop\\KOPIE\\dupa\\czysta\\vendor\\symfony\\ux-twig-component\\templates\\Collector\\twig_component.html.twig");
    }
}
