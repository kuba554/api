...
class __TwigTemplate_f9482cadd0ca4fd8272b99ccfe1f308d extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"modal fade\" id=\"sourceCodeModal\" tabindex=\"-1\">
        ...
        if ((isset($context["controller"]) || array_key_exists("controller", $context) ? $context["controller"] : (function () { throw new RuntimeError('Variable "controller" does not exist.', 21, $this->source); })())) {
            ...
            echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension']->formatFile(twig_get_attribute($this->env, $this->source, (isset($context["controller"]) || array_key_exists("controller", $context) ? $context["controller"] : (function () { throw new RuntimeError('Variable "controller" does not exist.', 22, $this->source); })()), "file_path", [], "any", false, false, false, 22), twig_get_attribute($this->env, $this->source, (isset($context["controller"]) || array_key_exists("controller", $context) ? $context["controller"] : (function () { throw new RuntimeError('Variable "controller" does not exist.', 22, $this->source); })()), "starting_line", [], "any", false, false, false, 22));
            echo "</small></h3>
                        <pre><code class=\"php\">";
            // line 23
        ...
        echo "</a><small class=\"pull-right\">";
        echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension']->formatFile(twig_get_attribute($this->env, $this->source, (isset($context["template"]) || array_key_exists("template", $context) ? $context["template"] : (function () { throw new RuntimeError('Variable "template" does not exist.', 29, $this->source); })()), "file_path", [], "any", false, false, false, 29), twig_get_attribute($this->env, $this->source, (isset($context["template"]) || array_key_exists("template", $context) ? $context["template"] : (function () { throw new RuntimeError('Variable "template" does not exist.', 29, $this->source); })()), "starting_line", [], "any", false, false, false, 29));
        echo "</small></h3>
                    <pre><code class=\"twig\">";
        // line 30
...
", "debug/source_code.html.twig", "C:\\Users\\admin\\Desktop\\KOPIE\\dupa\\czysta\\templates\\debug\\source_code.html.twig");
    }
}
