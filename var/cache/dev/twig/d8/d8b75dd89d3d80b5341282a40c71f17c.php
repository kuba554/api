...
class __TwigTemplate_92ab693e884dbe27a61e8515356b86ec extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getFunction('encore_entry_script_tags')->getCallable()("login"), "html", null, true);
        echo "
";
    ...
    <div class=\"row\">
        ...
        // line 31
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 31, $this->source); })()), "request", [], "any", false, false, false, 31), "get", ["redirect_to"], "method", false, false, false, 31), "html", null, true);
        echo "\"/>
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\admin\\Desktop\\KOPIE\\dupa\\czysta\\templates\\security\\login.html.twig");
    }
}
